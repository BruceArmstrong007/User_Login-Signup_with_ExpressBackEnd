...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2020-09-16 06:21:27',NULL),('diagnostics.include_raw','OFF','2020-09-16 06:21:27',NULL),('ps_thread_trx_info.max_length','65535','2020-09-16 06:21:27',NULL),('statement_performance_analyzer.limit','100','2020-09-16 06:21:27',NULL),('statement_performance_analyzer.view',NULL,'2020-09-16 06:21:27',NULL),('statement_truncate_len','64','2020-09-16 06:21:27',NULL);
...
-- Dump completed on 2020-09-23 16:14:47
-- MySQL dump 10.13  Distrib 8.0.21, for Win64 (x86_64)
--
...
CREATE TABLE `accounts` (
  ...
  PRIMARY KEY (`acc_id`,`email`),
  UNIQUE KEY `acc_id_UNIQUE` (`acc_id`),
  UNIQUE KEY `email_UNIQUE` (`email`),
  UNIQUE KEY `user_id_UNIQUE` (`user_id`),
  UNIQUE KEY `verify_UNIQUE` (`verify`)
...
INSERT INTO `accounts` VALUES (7,'bruce.armstrong09@gmail.com','$2a$10$KkfITZqQ7qZ3jXfuQkM3cuFYeS5IwtyD53bwwU840bkb7wwxKgF5m','2020-09-18',65440980,591373370),(8,'bruce.armstrong9@gmail.com','$2a$10$q8q6exJvD3B4DMqAu2.qceqeAxeZoQKkvtn6mZ/2/6BkSm85VZRie','2020-09-18',NULL,302729762),(9,'malik@gmail.com','$2a$10$2XmaicMmUdRCiDZ6mmYLeuvOe6aN9r9nTQMhSA.CbJl.1mp/av5gy','2020-09-20',NULL,129865875),(14,'bruce.armstrong0@gmail.com','$2a$10$nuDvxaMzXrMtjMl6oG.56.3vbJK5mhrdQatL.NGrbV6E8wqoCEr.m','2020-09-21',16462951,835789046),(113,'bruce.armst09@gmail.com',NULL,NULL,39193114,444387496);
...
INSERT INTO `sessions` VALUES ('-6xh_TZA6tGtF8NgMU650lT2l8s3tOw4',1600863647,'{\"cookie\":{\"originalMaxAge\":86400000,\"expires\":\"2020-09-23T12:20:46.772Z\",\"httpOnly\":true,\"path\":\"/\"}}'),('Auaxf9Do0Qg49nccoWZ9e2LfC4n2KJkF',1600863744,'{\"cookie\":{\"originalMaxAge\":86400000,\"expires\":\"2020-09-23T12:22:24.196Z\",\"httpOnly\":true,\"path\":\"/\"}}'),('EqOdd00ahCjgXhD3O2hIfIeQ0wOfACdh',1600944230,'{\"cookie\":{\"originalMaxAge\":86400000,\"expires\":\"2020-09-24T10:43:49.996Z\",\"httpOnly\":true,\"path\":\"/\"}}'),('LOH6HaloZg8pBoYGFMRbfElJ_vJF0Ynb',1600943346,'{\"cookie\":{\"originalMaxAge\":86400000,\"expires\":\"2020-09-24T10:29:06.188Z\",\"httpOnly\":true,\"path\":\"/\"}}'),('tFBwtd0WEQBO1rEizjzLeznulK4RJ8e4',1600943346,'{\"cookie\":{\"originalMaxAge\":86400000,\"expires\":\"2020-09-24T10:29:06.349Z\",\"httpOnly\":true,\"path\":\"/\"}}'),('yz9ATbUjqWxBP-BAw8YbIDVizVmACEjf',1600863956,'{\"cookie\":{\"originalMaxAge\":86400000,\"expires\":\"2020-09-22T17:54:25.805Z\",\"httpOnly\":true,\"path\":\"/\"}}');
...
INSERT INTO `user` VALUES (129865875,'Malik',22,'2002-09-20',9),(302729762,NULL,NULL,NULL,8),(444387496,NULL,NULL,NULL,113),(591373370,'Bruce Armstrong',22,'2002-09-22',7),(835789046,'pircle',23,'2002-09-21',14);
...
-- Dump completed on 2020-09-23 16:14:48
